...
export const GITHUB_ERROR_CODE = {
  ...
  CANNOT_DELETE_REPOSITORY_WEBHOOK: 'CANNOT_DELETE_REPOSITORY_WEBHOOK',
} as const;
...
export const PROJECT_ERROR_CODE = {
  ...
  FORBIDDEN_DELETE_PROJECT: 'FORBIDDEN_DELETE_PROJECT',
  PROJECT_HAS_ACTIVE_DEPLOYMENT: 'PROJECT_HAS_ACTIVE_DEPLOYMENT',
} as const;
